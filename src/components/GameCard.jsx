...
import { countLinkedPairsIn } from '../services/locationTrackerService';
...
const GameCard = ({ game, onSelect, onDelete, onFinish, onUnfinish, isFinished }) => {
  ...
  const getLocationStats = () => {
    ...
    return {
      ...
      battlegrounds: states.filter(s => s.type === 'battleground' && s.isOpened).length,
      // Pairs, not ends — counting isLinked records reports double.
      doors: countLinkedPairsIn(game)
    };
  };
      ...
      <div className="flex gap-6 mb-4">
        ...
        <div className="w-64">
          <div className="grid grid-cols-4 gap-2 text-xs text-center">
            ...
            <div className="bg-slate-700 rounded py-2">
              <div className="text-purple-400 font-bold text-lg">{stats.battlegrounds}</div>
